...
def create_data_split(x, y, experiment):
    ...
    elif experiment == 'traj':
        train_size = pd.read_csv('../data/df_traj_train.csv').shape[0]
        val_size = pd.read_csv('../data/df_traj_val.csv').shape[0]
        test_size = pd.read_csv('../data/df_traj_test.csv').shape[0]
    elif experiment == 'disabled':
        train_size = pd.read_csv('../data/df_disabled_train.csv').shape[0]
        val_size = pd.read_csv('../data/df_disabled_val.csv').shape[0]
        test_size = pd.read_csv('../data/df_disabled_test.csv').shape[0]
